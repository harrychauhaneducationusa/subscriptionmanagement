...
- `../canvases/subsense-ai-brd.canvas.tsx` - the interactive Cursor canvas version
...
This structure is designed so future artifacts can be added without turning the repository into a flat list of files. Suggested next documents include:

- Product Requirements Document
- User stories and epics
- API and integration notes
- UX flows and wireframe references
- Release plans
- Investor or pitch summaries
